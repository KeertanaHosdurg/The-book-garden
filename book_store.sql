...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2019 at 11:59 AM
...
(26, 'On Liberty', '8', 'the liberal tradition, revered for his defense of liberal principles and expansive personal liberty.', 'Princeton University Press', '2001', 'li-11', 264, 300, 'upload_image/li1.jpg'),
(27, 'On Liberty in Focus', '8', 'his book gathers together for the first time J.S. Mill\'\'s On Liberty and a selection of importantessays by the eminent scholars Isaiah Berlin, Alan Ryan, John Rees C.L. Ten\'', 'John Stuart Mill', '2002', 'li-22', 296, 350, 'upload_image/li2.jpg'),
...
(49, 'PAKISTAN`S DRIFT INTO EXTREMISM', '13', 'The book studies the rise of religious extremism in pakistan and analyses its connection to the pakistani army policies and fluctuating US - Pakistani Relationship. It is a book which readers as well as students of Political Science and history will enjoy thoroughly.', 'Hassan Abbas ', '2001', '8182741580', 350, 600, 'upload_image/terr2.jpg'),
...
(63, 'Programming with C', '38', 'Very good book for c programming begginers', 'Prisem', '6th', '1233', 550, 350, 'images/Programming with C.jpg');
...
(7, 'Alok', 'alok.mc', 'pass', 'Male', 'alok.mc@gmail.com', '8050105610', 'SHIMOGA');
...
--
ALTER TABLE `book`
  MODIFY `b_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
-- AUTO_INCREMENT for table `category`
--
ALTER TABLE `category`
  MODIFY `cat_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `user`
  MODIFY `u_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;COMMIT;
